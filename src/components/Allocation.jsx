...
function Allocation() {
  ...
  return (
    <div style={{background: "url(/src/assets/background2.svg)"}} className='bg-no-repeat md:bg-left bg-center bg-cover rounded-lg  mx-6 bg-secondary grid md:grid-cols-3 md:min-h-[50vh] lg:min-h-[55vh] min-h-[40vh]'>
